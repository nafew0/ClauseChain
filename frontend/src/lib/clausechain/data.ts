...
export const REJECTIONS = {
  total: 77,
  byGate: [
    { gate: 'Gate 1 — Span Match', count: 18, pct: 23, color: '#3B82F6' },
    { gate: 'Gate 2 — NLI Entailment', count: 41, pct: 53, color: '#F59E0B' },
    { gate: 'Gate 3 — Structural Plausibility', count: 18, pct: 24, color: '#EF4444' },
  ],
  recent: [
    { clauseId: 'BD-DSA-2018-§28',  proposedPillar: 'Pillar 12.1', failedGate: 'Gate 2 (NLI)', score: '0.15' },
    { clauseId: 'TH-PDPA-§48',      proposedPillar: 'Pillar 6.3',  failedGate: 'Gate 1 (Span)', score: '—' },
    { clauseId: 'SG-PDPA-§26',      proposedPillar: 'Pillar 7.2',  failedGate: 'Gate 3 (Struct)', score: '0.42' },
    { clauseId: 'BD-ICT-§57',       proposedPillar: 'Pillar 8.1',  failedGate: 'Gate 2 (NLI)', score: '0.31' },
    { clauseId: 'TH-ECTA-§35',      proposedPillar: 'Pillar 9.2',  failedGate: 'Gate 1 (Span)', score: '—' },
  ],
}
